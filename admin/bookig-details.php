			...
			<body>
			  <div class="container">
				...
				<div class="message">
				  ...
				  <p>We apologize for any inconvenience caused. If you have any questions or need further assistance, please dont hesitate to contact our customer support team.</p>
				  <p>Thank you for considering our services. We hope to have the opportunity to serve you in the future.</p>
				  <p>Best regards,</p>
...
DATEDIFF(tblbooking.ToDate,tblbooking.FromDate) as totalnodays,tblvehicles.PricePerDay
	...
	<h3 style="text-align:center; color:red">#<?php echo htmlentities(
     $result->BookingNumber
		...
		<tr>
										...
										<tr>
											...
											<tr>											
											<th>Vehicle Name</th>
											<td><a href="edit-vehicle.php?id=<?php echo htmlentities(
               $result->vid
...
<td><?php if ($result->Status == 0) {
    ...
    echo htmlentities('Cancelled');
				...
				<a href="bookig-details.php?aeid=<?php echo htmlentities(
        $result->id
    ); ?>" onclick="return confirm('Do you really want to Confirm this booking')" class="btn btn-primary"> Confirm Booking</a> 

<a href="bookig-details.php?eid=<?php echo htmlentities(
    $result->id
); ?>" onclick="return confirm('Do you really want to Cancel this Booking')" class="btn btn-danger"> Cancel Booking</a>
</td>
</tr>
<?php } ?>
										<?php $cnt = $cnt + 1;}
